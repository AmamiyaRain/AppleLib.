    ...
    <div style="margin-left: 30px">
        <div class="pure-g" style="margin: auto;width: 70%;margin-bottom: 800px">
            ...
            <form name="fm1" method="post" action="uploadDemo.php" enctype="multipart/form-data" class="pure-form">
                ...
                echo "<span style='font-size: 250%;font-weight: bolder'>{$_SESSION['nowAdmin']['userName']}，</span><span style='font-size: 250%'>你好。</span>";
                echo "</div>";
                echo "<div class='pure-u-1-1' style='margin-bottom: 30px'>";
                echo "<span style='font-size: 150%;color: #9a9a9a'>{$_SESSION['nowAdmin']['userEmail']}</span>";
                echo "</div>";
                echo "</div>";
                echo "<div class='pure-u-1-2'>";
                ?>
                <div style="margin-top: 110px">
                    <div class="pure-u-1-1" style="text-align: center;margin: 10px 0">
                        <input type="text" name="name"
                               ...
                               placeholder="更改姓名" value="<?php echo $_SESSION['nowAdmin']['userName'] ?>">
                    </div>
                    ...
                    <div class="pure-u-1-1" style="text-align: center;margin: 10px 0">
                        <input type="password" name="psd" style="width: 400px;height: 50px" placeholder="更改密码" value="<?php echo $_SESSION['nowAdmin']['userPsd'] ?>">
                    </div>
                    <div class="pure-u-1-1" style="text-align: center;margin: 10px 0">
                        <input type="password" name="psd_C" style="width: 400px;height: 50px"
                               placeholder="确认密码" value="<?php echo $_SESSION['nowAdmin']['userPsd'] ?>">
                    </div>
                    <div class="pure-u-1-1"
                         style="text-align: center;margin-top: 5px;margin-bottom:50px;font-size: 100%;color: #9a9a9a;">
