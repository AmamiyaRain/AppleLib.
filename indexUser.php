...
<div id="layout" style="height: 1000px">
    ...
    <div style="margin-left: 30px">
        <div class="pure-g" style="margin: auto;width: 70%;margin-bottom: 800px">
            ...
            echo "<div class='pure-u-1-1' style='margin-top: 100px;margin-bottom: 30px'><img class='animate__animated animate__zoomIn' style='width: 250px;height: 250px;border-radius:50%' src='./avatar/{$_SESSION['nowUser']['userAvatar']}'>";
            ?>
            <form name="fm1" method="post" action="uploadDemo.php" enctype="multipart/form-data" class="pure-form">
                <div style="margin-left: 180px;margin-top: -50px">
                    ...
                    <label for="file-5" class="animate__animated animate__zoomIn" style="text-align: center">
                        <figure>
                ...
                echo "<div class='pure-u-1-2'>";
                ?>
                <div style="margin-top: 110px" class="animate__animated animate__fadeInRight">
